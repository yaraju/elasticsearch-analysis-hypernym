...
public class HypernymTokenFilterFactory extends org.elasticsearch.index.analysis.AbstractTokenFilterFactory {
    ...
    @Inject
    public HypernymTokenFilterFactory(Index index, @IndexSettings Settings indexSettings, String name, Settings settings) {
        ...
        if (settings.get("hypernyms_path") != null) {
            ...
            throw new IllegalArgumentException("hypernym requires `hypernyms_path` to be configured");
        }
